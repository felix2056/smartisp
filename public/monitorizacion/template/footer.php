...
<footer class="main-footer no-print">
	<!-- <div class="pull-right hidden-xs">
		...
		<b><?php echo strip_tags ( getConfigValue("app_name") ); ?></b> 1.8 - <?php echo $total_time; ?><?php _e('s'); ?>
	</div>
	&nbsp; -->
	<div class="">Copyright © 2019 SmartISP , All rights reserved.</div>
</footer>
...
<script src="/monitorizacion/template/assets/plugins/daterangepicker/moment-timezone-with-data-2012-2022.min.js"></script>
...
<!-- Form Validator -->
<script src="/monitorizacion/template/assets/plugins/form-validator/jquery.form-validator.min.js"></script>

<!-- clipboard -->
<script src='/monitorizacion/template/assets/plugins/clipboard/clipboard.min.js'></script>
<!-- FastClick -->
