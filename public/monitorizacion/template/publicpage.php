...
<head>
  ...
  <link rel="shortcut icon" href="/monitorizacion/template/assets/icon.png"/>
  <link rel="apple-touch-icon" href="/monitorizacion/template/assets/icon-large.png"/>
  <link rel="image_src" href="/monitorizacion/template/assets/icon-large.png"/>
  <!-- Bootstrap 3.3.7 -->
  <link href="/monitorizacion/template/assets/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
  <!-- Font Awesome -->
  <link rel="stylesheet" href="/monitorizacion/template/assets/plugins/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="/monitorizacion/template/assets/plugins/ionicons/css/ionicons.min.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="/monitorizacion/template/assets/plugins/datatables/datatables.min.css">
  <!-- Select2 -->
  <link rel="stylesheet" href="/monitorizacion/template/assets/plugins/select2/select2.min.css">
  <!-- Pace style -->
  <link rel="stylesheet" href="/monitorizacion/template/assets/plugins/pace/pace.min.css">
  <!-- Date Picker -->
  <link href="/monitorizacion/template/assets/plugins/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
  <!-- daterange picker -->
  <link href="/monitorizacion/template/assets/plugins/daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css" />
  <!-- summernote wysihtml5 - text editor -->
  <link href="/monitorizacion/template/assets/plugins/summernote/summernote.css" rel="stylesheet" type="text/css" />

  <!-- jvectormap -->
  <link rel="stylesheet" href="/monitorizacion/template/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
  <!-- Google Font -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">

  <!-- Theme style -->
  <link href="/monitorizacion/template/assets/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
		<!-- AdminLTE Skins. Choose a skin from the css/skins
      folder instead of downloading all of them to reduce the load. -->
      <link href="/monitorizacion/template/assets/dist/css/skins/_all-skins.css" rel="stylesheet" type="text/css" />

      <!-- CUSTOM CSS -->
      <link href="/monitorizacion/template/assets/custom.css" rel="stylesheet" type="text/css" />

      <!-- jQuery 2.2.3 -->
      <script src="/monitorizacion/template/assets/plugins/jQuery/jquery-2.2.3.min.js"></script>
    </head>
                          ...
                          <tbody>
                           ...
                           <?php if(!empty($latest)) { ?>
                            ...
                            <td>
                             ...
                             if(stripos($os, 'centos') !== false) { echo '<img src="/monitorizacion/template/images/centos.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'cloudlinux') !== false) { echo '<img src="/monitorizacion/template/images/cloudlinux.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'coreos') !== false) { echo '<img src="/monitorizacion/template/images/coreos.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'debian') !== false) { echo '<img src="/monitorizacion/template/images/debian.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'fedora') !== false) { echo '<img src="/monitorizacion/template/images/fedora.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'freebsd') !== false) { echo '<img src="/monitorizacion/template/images/freebsd.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'proxmox') !== false) { echo '<img src="/monitorizacion/template/images/proxmox.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'redhat') !== false) { echo '<img src="/monitorizacion/template/images/redhat.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'routeros') !== false) { echo '<img src="/monitorizacion/template/images/routeros.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'suse') !== false) { echo '<img src="/monitorizacion/template/images/suse.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'ubuntu') !== false) { echo '<img src="/monitorizacion/template/images/ubuntu.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             elseif(stripos($os, 'windows') !== false) { echo '<img src="/monitorizacion/template/images/windows.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             else { echo '<img src="/monitorizacion/template/images/other.png" data-toggle="tooltip" title="'.$os.'" alt="'.$os.'">'; }
                             ?>
                           </td>
...
<!-- jQuery UI 1.11.4 -->
<script src="/monitorizacion/template/assets/plugins/jQueryUI/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button);
</script>
<!-- Bootstrap 3.3.7 -->
<script src="/monitorizacion/template/assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<!-- PACE -->
<script src="/monitorizacion/template/assets/plugins/pace/pace.min.js"></script>
<!-- Select2 -->
<script src="/monitorizacion/template/assets/plugins/select2/select2.full.min.js"></script>
<!-- DataTables -->
<script src="/monitorizacion/template/assets/plugins/datatables/datatables.min.js"></script>

<!-- date range picker -->
<script src="/monitorizacion/template/assets/plugins/daterangepicker/moment.min.js"></script>
<script src="/monitorizacion/template/assets/plugins/daterangepicker/daterangepicker.js"></script>

<!-- datepicker -->
<script src="/monitorizacion/template/assets/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript"></script>
<!-- Summernote WYSIHTML5 -->
<script src="/monitorizacion/template/assets/plugins/summernote/summernote.min.js" type="text/javascript"></script>
<!-- Slimscroll -->
<script src="/monitorizacion/template/assets/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<!-- Chart JS 2 -->
<script src="/monitorizacion/template/assets/plugins/chartjs2/dist2/Chart.bundle.min.js"></script>

<!-- FastClick -->
<script src='/monitorizacion/template/assets/plugins/fastclick/fastclick.min.js'></script>
<!-- peity -->
<script src='/monitorizacion/template/assets/plugins/peity/jquery.peity.min.js'></script>
<!-- AdminLTE App -->
<script src="/monitorizacion/template/assets/dist/js/app.min.js" type="text/javascript"></script>

<!-- jvectormap  -->
<script src="/monitorizacion/template/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/monitorizacion/template/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- nMon -->
<script src="/monitorizacion/template/assets/app.js" type="text/javascript"></script>
