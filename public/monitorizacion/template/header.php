...
<head>
  ...
  <title>SmartISP - Monitorización</title>
  ...
  .skin-green .sidebar-menu > li:hover > a, .skin-green .sidebar-menu > li.active > a {
    ...
    background-color: #2b859c !important;
  }
  .sidebar-menu>li>a {
...
<link href="/monitorizacion/template/assets/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="hold-transition <?php echo $liu['theme']; ?> <?php echo $liu['layout']; ?> <?php if($liu['sidebar']=="collapsed") echo "sidebar-collapse"; ?> sidebar-mini">
      <div class="wrapper">
        ...
        <header class="main-header">
          <a href="?route=dashboard" class="logo">
            ...
            <span class="logo-lg">Monitorización</span>
                        ...
                        <?php foreach($main_servers_unresolved as $incident) { ?>
                          <li>
                            <a href="?route=servers/manage-<?php echo getSingleValue("app_servers","type",$incident['serverid']); ?>&id=<?php echo $incident['serverid']; ?>">
                              ...
                              <?php if($incident['type'] == "load1min") _e('monitorizacion Load 1 Min'); ?>
                              <?php if($incident['type'] == "load5min") _e('monitorizacion Load 5 Min'); ?>
                              <?php if($incident['type'] == "load15min") _e('monitorizacion Load 15 Min'); ?>
                ...
                <li class="dropdown user user-menu">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <div class="pull-right">
                      <a href="/dashboard" class="btn btn-default btn-flat"><?php _e('Volver al Escritorio'); ?></a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li >
        <a href="/dashboard">
          <i class="fa fa-home fa-fw"></i> <span><?php _e('Volver al Escritorio'); ?></span>
        </a>
      </li>
      ...
      <!--   <li <?php if(strpos($route,'pages') !== false) echo 'class="active"'; ?>>
        ...
        <?php if(in_array("viewSystem",$perms)) { ?>
          <li class="treeview<?php if(strpos($route,'system/') !== false) echo ' active'; ?>">
            ...
            <ul class="treeview-menu">
             <!--  <?php if(in_array("viewUsers",$perms)) { ?><li <?php if(strpos($route,'system/users') !== false) echo 'class="active"'; ?>><a href="?route=system/users"><i class="fa fa-angle-double-right"></i> <?php _e('Users'); ?></a></li>
