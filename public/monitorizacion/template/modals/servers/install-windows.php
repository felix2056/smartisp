<div class="modal-header">
    ...
    <h4 class="modal-title"><?php _e('Install Smartisp Server Agent'); ?></h4>
</div>

<div class="modal-body">

    <h4><?php _e('Follow the steps below to install the Smartisp Windows Agent on this server:'); ?></h4>
    ...
    <p><b>2.</b> <?php _e('Open Smartisp Agent after installation finishes.'); ?>.<br></p>
    ...
    <p><?php _e('Agent will begin reporting data to Smartisp in a few minutes.'); ?></p>
