     		...
     		<div class="box box-primary">
     			...
     			<div class="box-body">
     				...
     				<?php } else { ?>
     					<div class="callout callout-ok">
     						<p class="lead"><i class="icon fa fa-check text-green"></i> <?php _e("¡Hurra! Todos los servidores están ONLINE.") ?></p>
     					</div>
     				<?php } ?>
     			</div>
     		</div>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<?php } else { ?>
							<div class="callout callout-ok">
								<p class="lead"><i class="icon fa fa-check text-green"></i> <?php _e("¡Hurra! Todos los controles están ONLINE.") ?></p>
							</div>
						<?php } ?>
					</div>
				</div>
