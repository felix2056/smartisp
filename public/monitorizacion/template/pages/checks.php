<aside class="right-side">
	...
	<section class="content-header">
		...
		<div class="pull-right">
			...
			<a href="/monitorizacion/crons/refresh.php" class="btn btn-flat btn-primary btn-sm"><i class="ace-icon fa fa-refresh"></i> <?php _e('REFRESH'); ?></a>

			<?php if(in_array("addCheck",$perms)) { ?><a onClick='showM("?modal=checks/add&reroute=checks");return false' data-toggle="modal" class="btn btn-flat btn-primary btn-sm"><?php _e('ADD CHECK'); ?></a><?php } ?></div>
