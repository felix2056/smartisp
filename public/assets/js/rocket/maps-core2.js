        ...
        onEachFeature: (feature, layer) => {
            layer.on({
                click: (e) => {
                    ...
                    $('#change_line_color').data('layer-id', item.id);
...
function saveGeoJson(layer) {
    ...
    $.ajax({
        "type": "PATCH",
        "url": `${baseUrl}/clients/${layer.id}/odb-geo-json`,
        "data": {
            geo_json: geoFeature,
