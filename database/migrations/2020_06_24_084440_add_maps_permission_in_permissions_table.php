...
class AddMapsPermissionInPermissionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('permissions', function (Blueprint $table) {
            $table->string('maps_client_access')->default(1);
            $table->string('locations_access')->default(1);
        });
    ...
    {
        Schema::table('permissions', function (Blueprint $table) {
            $table->dropColumn('maps_client_access');
            $table->dropColumn('locations_access');
        });
    }
}
