...
class AddContractTemplateInTemplatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \Illuminate\Support\Facades\DB::statement('INSERT INTO `templates` (`id`, `name`, `registered`, `type`, `system`, `filename`, `content`) VALUES (NULL, \'contract\', \'2021-10-23\', \'contract\', \'0\', \'contract.blade.php\', \'<div class=WordSection1 style="margin: 10px 50px 10px 50px;">
