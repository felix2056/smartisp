...
<a class="red del" href="javascript:;" onclick="deleteProduct('.$row->id.')" id="' .$row->id. '"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
    ...
    public function query(Product $model)
    {
        ...
        return $model->with('vendor', 'product_items')
            ...
            ->where('inv_supplier_invoice.supplier_id', $supplierId)
            ->groupBy('inv_products.id')
            ->select('id', 'inv_products.vendor_id', 'inv_products.name', 'inv_products.sell_price', 'inv_products.rent_price', 'inv_products.photo');
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.vendor') => ['data' => 'vendor.name', 'name' => 'vendor.name'],
