...
class RouterClientDataTable extends DataTable
{
    protected $global;
    protected $campos_v;
...
//                return $expiration;
    ...
    public function query(Client $model)
    {
        ...
        if ($request->route('routerId')) {
            $users = $users->where('client_services.router_id', $request->route('routerId'));
        }
    ...
    public function html()
    {
        ...
        return $this->builder()
            ->setTableId('router-client-table')
            ...
            ->parameters([
                'initComplete' => 'function () {
                   window.LaravelDataTables["router-client-table"].buttons().container()
