<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i>
        @lang('app.edit') @lang('app.supplierInvoice')</h4>
</div>
    ...
    <div class="modal-body">
        <div class="modal-body">
                ...
                <div class="col-sm-9">
                    <select name="supplier_id" class="form-control" id="supplier_id">
                        @forelse($suppliers as $supplier)
                            <option value="{{ $supplier->id }}" @if($invoice->supplier_id == $supplier->id) selected @endif>{{ $supplier->name }}</option>
                        @empty
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input id="invoice_number" class="form-control" type="text" name="invoice_number" value="{{ $invoice->invoice_number }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9">
                    <input
                            ...
                            type="text"
                            autocomplete="false"
                            name="invoice_date" value="{{ $invoice->invoice_date->format('d/m/Y') }}">
                </div>
            </div>
            ...
            <div class="content-table-overflow-auto">
                <table class="table" id="admin_customers_billing_invoice_items">
                    ...
                    <tbody>
                    @forelse($invoice->product_items as $item)
                        <tr class="rows">
                            <td>
                            ...
                            <td>
                                <input type="text" name="quantity[]" value="{{ $item->quantity }}" readonly class="quantity form-control input-sm" style="width:50px">
                            </td>
                            <td>
                                <input type="text" name="price[]" value="{{ $item->amount }}" class="price decimal form-control input-sm" style="width:80px">
                            </td>
                            <td>
                    ...
                    @empty
                        <tr class="rows">
                            <td>
                                <input type="text" name="id[]" value="0" class="id" style="width:40px; display: none;">
                                <input type="text" name="pos[]" value="0" class="pos form-control input-sm" style="width:40px">
                            </td>
                            <td>
                                <select id="products" name="products[]" class="form-controls input-sm">
        ...
        <div class="modal-footer" id="swfoot">
            ...
            <button type="button" class="btn btn-primary" onclick="addUpdateSupplierInvoice('{{ $invoice->id }}'); return false;" ><i class="fa fa-floppy-o"></i>
...
<script>
    ...
    $('#admin_customers_billing_invoice_items').on('click', '.add_row', function() {
        ...
        clone.find('.quantity').removeAttr('readonly');
