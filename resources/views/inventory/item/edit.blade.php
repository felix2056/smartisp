...
<form class="form-horizontal" method="post" id="add_edit_item" autocomplete="off">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input id="bar_code" class="form-control" type="text" name="bar_code" value="{{ $item->bar_code ?? '' }}">
            </div>
        </div>
        <div class="form-group">
            <label for="name" class="col-sm-3 control-label"> @lang('app.serialNumber')</label>
            <div class="col-sm-9">
                <input id="serial_number" class="form-control" type="text" name="serial_number" value="{{ $item->serial_code ?? '' }}">
            </div>
        </div>
        <div class="form-group">
            <label for="name" class="col-sm-3 control-label"> @lang('app.costPrice')</label>
            <div class="col-sm-9">
                <input id="amount_with_tax" class="form-control" type="number" name="amount_with_tax" value="{{ $item->amount_with_tax ?? '' }}">
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="modal-footer" id="swfoot">
        ...
        <button type="button" class="btn btn-primary" onclick="addUpdateItem('{{ $item->id }}'); return false;" ><i class="fa fa-floppy-o"></i>
