<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i>
        @lang('app.rentToCustomer')</h4>
</div>
<form class="form-horizontal" method="post" id="rent_item" autocomplete="off">
    {{ csrf_field() }}
    <div class="modal-body">
        ...
        <div class="form-group">
            <label for="name" class="col-sm-3 control-label"> @lang('app.router')</label>
            <div class="col-sm-9">
        ...
        <div class="content-table-overflow-auto">
            <table class="table" id="admin_customers_billing_invoice_items">
                ...
                <tr class="rows">
                    ...
                    <td>
                        <input type="text" name="description[]" value="{{ $item->product->name }}" readonly class="product form-control input-sm">
                        {{--<input type="hidden" name="productId[]" value="{{ $item->product->id }}" class="product form-control input-sm">--}}
                    </td>
                    <td>
                        <input type="text" name="quantity[]" value="1" class="quantity form-control input-sm" readonly style="width:50px">
                    </td>
                    <td>
                        <input type="text" name="price[]" value="{{ $item->product->rent_price }}" class="price decimal form-control input-sm" readonly style="width:80px">
                    </td>
                    <td>
                        <input type="text" name="iva[]" value="{{ $item->tax }}" class="tax_percent tax_input form-control input-sm" readonly style="width:60px">
                    </td>
                    <td>
                        <input type="text" name="with_tax[]" disabled class="with_tax decimal form-control input-sm" readonly value="{{ $item->amount_with_tax }}" style="width:80px">
                    </td>
                    <td>
                        <input type="text" name="total[]" readonly class="total decimal form-control input-sm" readonly value="{{ $item->amount_with_tax }}" style="width:80px">
                    </td>
                </tr>
    ...
    <div class="modal-footer" id="swfoot">
        ...
        <button type="button" class="btn btn-primary" onclick="rentItemSave('{{ $item->id }}'); return false;" ><i class="fa fa-floppy-o"></i>
