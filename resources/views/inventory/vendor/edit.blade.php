...
<form class="form-horizontal" method="post" id="add_edit_vendor" autocomplete="off">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input id="name" class="form-control" type="text" name="name" value="{{ $vendor->name }}">
            </div>
        </div>
    </div>
    <div class="modal-footer" id="swfoot">
        <button type="button" class="btn btn-default" data-dismiss="modal">@lang('app.close')</button>
        <button type="button" class="btn btn-primary" onclick="addUpdateVendor('{{ $vendor->id }}'); return false;" ><i class="fa fa-floppy-o"></i>
