									...
									<form action="#" class="form-horizontal">
										<div class="form-horizontal">
											<div class="form-group">
												<label class="col-sm-1 control-label"><span class="blanco">NAPs</span>:</label>
												<div class="col-sm-5">
													<select class="form-control" id="router">
														<option value="0" selected>Todas las NAPs</option>
													</select>
												</div>
											</div>
										</div>
...
@section('scripts')
	...
	<script src="{{asset('/assets/js/rocket/maps-core2.js')}}"></script>
