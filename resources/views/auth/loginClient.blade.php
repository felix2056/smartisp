                ...
                <div class="login-container">
                    <div class="center">
                        ...
                        <div id="content_cuadro">
                            <h2 class="text-center"><strong style="color: #fff">@lang('app.clientPortal')</strong></h2>
                            ...
                            @if(Session::has('adv'))
                                <div class="alert alert-danger" role="alert">
                                            ...
                                            class="fa fa-exclamation-triangle"></i> @lang('app.dearCustomerYourInternetServiceIsSuspended')
                                </div>
                            @endif
