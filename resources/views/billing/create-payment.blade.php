<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-money"></i>
        @lang('app.add') @lang('app.new') @lang('app.payment')</h4>
</div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="input-group" style="padding: 0;font-size: 13px;">
                    <input id="date" class="form-control datepicker" value="{{ \Carbon\Carbon::now()->format('m/d/Y') }}" style="width: 100%;" type="text" original-value="" force-send="0" autocomplete="false" name="date" readonly>
...
{{--            </div>--}}
    ...
    <div class="modal-footer" id="swfoot">
        ...
        <button type="button" class="btn btn-primary" onclick="savePayment(); return false;" ><i class="fa fa-floppy-o"></i>
