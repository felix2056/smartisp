                            ...
                            <div class="col-xs-12 col-sm-12 widget-container-col">
                                <div class="widget-box widget-color-blue2">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Establecimientos</h5>
...
@section('scripts')
    ...
    <script>
        ...
        function new_establecimeinto(){
            var url = '{{route('establecimientos.newInvoice')}}';
        ...
        function renderDataTable () {
            table = $('#transaction-table').DataTable({
                ...
                buttons:[],
                ajax: {
                    "url": "{{ route('establecimientos.invoice.lists') }}",
                    "type": "POST",
                    "cache": false,
                },
                columns: [
                    ...
                    {name:'url', data: 'url'},
                    {name:'nombreComercial', data: 'nombreComercial'},
                    {name:'direccion', data: 'direccion', sortable: false, searchable: false},
        ...
        function editarEstablecimiento (id) {
            var url = '{{ route('establecimientos.showInvoice', ':id') }}';
            url = url.replace(':id', id);
        ...
        function eliminarEstablecimiento (id){
            var url = '{{ route('establecimientos.delete', ':id') }}';
            url = url.replace(':id', id);
