        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ URL::to('routers') }}">{{ __('app.routers') }}</a>
                    </li>
                    <li>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#router-client-table').on('preXhr.dt', function (e, settings, data) {
            ...
            $(document).on("click", "#search", function () {
                window.LaravelDataTables["router-client-table"].draw();
                getClientStats();
            });
            ...
            function getClientStats() {
                ...
                //obtenemos el tipo de control
                $.ajax({
                    "url": "{{ route('router.client.filter-totals', $routerId) }}",
                    "type": "POST",
                    "data": data,
                    "dataType": "json",
                    'error': function (xhr, ajaxOptions, thrownError) {
