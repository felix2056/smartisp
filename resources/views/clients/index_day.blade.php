        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1 style="background: #f8940673;padding: 10px;">
                        {{ __('app.clients') }} con promesa de pago
                        <small>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{-- <button type="button" class="btn btn-success newcl" data-toggle="modal" data-target="#add">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 widget-container-col">
                                <div class="widget-box widget-color-blue2">
                                    <div class="widget-header">
                                        <h5 class="widget-title">{{ __('app.allCustomers') }} con días adicionados</h5>
                            ...
                            <!--start modal add-->
                            <div class="modal fade" id="campos_visibles" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="col-xs-8 col-sm-5">
                                                            ...
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <span class="lbl"> {{ __('app.control') }}</span>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <span class="lbl"> {{ __('app.service') }}</span>
                                                                </label>
                                                            </div>
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <span class="lbl"> {{ __('app.balance') }}</span>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="checkbox">
                                                                <label>
                                                                    ...
                                                                    <span class="lbl"> {{ __('app.serviceCut') }}</span>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input name="campos_acc[]" value="onusn"
                                                                           id="edit_onusn_c" type="checkbox"
                                                                           class="ace" {{ ($campos_v->onusn)?'checked':'' }}/>
                                                                    <span class="lbl"> ONUs SN</span>
                                                                </label>
                                                            </div>
                                        ...
                                        <div class="modal-body" id="winnew">
                                            ...
                                            <div class="tabbable">
                                                <ul class="nav nav-tabs" id="ro">
                                                    <li class="active"><a data-toggle="tab" href="#dclient"><i
                                                                class="fa fa-info-circle"></i> {{ __('app.clientData') }}
                                                        </a>
                                                    </li>
                                                    <li id="redes"><a href="#connection" role="tab"
                                                                      data-toggle="tab"><i
                                                                class="fa fa-sitemap"></i> {{__('app.mikrotikConnection')}}
                                                        </a></li>
                                                    <li id="internet"><a href="#bill" role="tab"
                                                                         data-toggle="tab"><i
                                                                class="fa fa-file-o"></i> {{ __('app.billing') }}</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content" id="mytabs">
                                                    <div id="dclient" class="tab-pane fade in active">

                                                        <form class="form-horizontal" id="formaddclient1">
                                                            <div class="form-group">
                                                                <label for="name"
                                                                       class="col-sm-3 control-label">{{ __('app.fullName') }}
                                                            ...
                                                            <div class="form-group">
                                                                <label for="email"
                                                                       class="col-sm-3 control-label">{{ __('app.email') }}
                                                                    <span class="text-danger">*</span></label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="dni"
                                                                       class="col-sm-3 control-label">{{ __('app.number') }}
                                                            ...
                                                            <div class="form-group">
                                                                <label for="dir"
                                                                       class="col-sm-3 control-label">Caja</label>
                                                                <div class="col-sm-9">
                                                                    <select class="form-control onchange_caja"
                                                                            name="odb_id">
                                                                        <option value="">Seleccione Caja</option>
                                                                        @foreach($OdbSplitter as $zo)
                                                                            <option
                                                                                value="{{ $zo->id }}">{{ $zo->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group content_port_s">
                                                                <label for="dir" class="col-sm-3 control-label">Puertos
                                                                    Disponibles</label>
                                                                <div class="col-sm-9">
                                                                    <select class="form-control select_port"
                                                                            name="port">
                                                            ...
                                                            <div class="form-group content_port_s">
                                                                <label for="dir"
                                                                       class="col-sm-3 control-label">Zonas</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="dir"
                                                                       class="col-sm-3 control-label">ONUs/CPE</label>
                                                                <div class="col-sm-9">
                                                                    <select class="form-control change_unus"
                                                                            name="onu_id">
                                                            ...
                                                            <input type="hidden" class="zona_value" name="zona_id"
                                                                   id="zona_id_input">
                                                            <div class="form-group content_zona_select">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    <select class="form-control zona_id_input"
                                                                            name="zona_ident" id="zona_id">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="pass"
                                                                       class="col-sm-3 control-label">{{ __('app.password') }}
                                                                    ...
                                                                    <div class="checkbox">
                                                                        <label>
                                                                            <input type="checkbox" id="showp"
                                                                                   class="ace">
                                                                            <span
                                                                                class="lbl"> {{ __('app.seePassword') }}</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div id="connection" class="tab-pane fade">
                                                        <form class="form-horizontal" role="form" id="formaddcon">
                                                            ...
                                                            <div class="form-group" id="typeauth">
                                                                <label for="slauth"
                                                                       class="col-sm-3 control-label">{{ __('app.logIn') }}
                                                                    (hotspot)</label>
                                                                <div class="col-sm-9">
                                                                    <select class="form-control" name="auth"
                                                                            id="slauth">
                                                                        <option value="userpass"
                                                                                selected>{{ __('app.userPassword') }}
                                                                        </option>
                                                                        <option value="mac">MAC
                                                                            - {{__('app.automaticLogin')}}
                                                                        </option>
                                                                        <option value="binding">
                                                                            IP {{__('app.bindingBypassed')}}
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            </div>
                     ...
                     <span class="input-group-addon"><i class="fa fa-search" aria-hidden="true"></i>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="mac"
                                                                       class="col-sm-3 control-label">{{__('app.direction')}}
                                                                    MAC</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="onusn" class="col-sm-3 control-label">ONUs
                                                                    SN
                                                                </label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" name="onusn"
                                                                           class="form-control" autocomplete="off"
                                                                           id="onusn">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane" id="bill">
                                                        <form class="form-horizontal" id="formbill">
                                                            <div class="form-group">
                                                                <label for="edit_slcplan"
                                                                       class="col-sm-3 control-label">{{ __('app.typeOfBilling') }}</label>
                                                                <div class="col-sm-9">
                                                                    <select class="form-control" name="billing_type"
                                                                            id="billing_type">
                                                                        <option
                                                                            value="recurring">{{ __('app.recurringPayment') }}</option>
                                                                        <option
                                                                            value="prepaid-monthly">{{__('app.prepaid')}}
                                                                            (Monthly)
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="form-group" id="pl">
                                                                <label for="slcplan"
                                                                       class="col-sm-3 control-label">{{__('app.internetPlan')}}</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="dir"
                                                                       class="col-sm-3 control-label"> @lang('app.billingDay')</label>
                                                                <div class="col-sm-9">
                                                                    <select type="select" id="billing_date"
                                                                            style="width: 100%;" original-value="1"
                                                                            force-send="0"
                                                                            class="select2 select2-hidden-accessible"
                                                                            name="billing_date" tabindex="-1"
                                                                            aria-hidden="true">
                                                                        @for ($i = 1; $i < 32; $i++)
              ...
              <i class="fa fa-calendar bigger-110"></i>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="regpay"
                                                                       class="col-sm-3 control-label">{{ __('app.registerPayment') }}</label>
                                                                <div class="col-sm-9">
                                                                    <div class="checkbox">
                                                                        <label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".recargar", function (event) {
                window.LaravelDataTables["day-free-table"].draw();
                check_is_online();
