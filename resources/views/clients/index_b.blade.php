                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select type="select" id="customers_billing_due" style="width: 100%;"
                                        ...
                                        name="billing_due_date" tabindex="-1" aria-hidden="true">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#client-locked-table').on('preXhr.dt', function (e, settings, data) {
            ...
            $(document).on("click", "#search", function () {
                window.LaravelDataTables["client-locked-table"].draw();
            });
