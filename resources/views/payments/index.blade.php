        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">@lang('app.payments')</li>
                </ul>
            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 widget-container-col">
                                <div class="widget-box widget-color-blue2">
                                    <div class="widget-header">
                                        <h5 class="widget-title">@lang('app.payments')</h5>
...
@section('scripts')
    ...
    <script>
        ...
        function editPayment(id) {
            ...
            url = url.replace(':id', id) + '?client_id=' + '{{$clients}}';

            $.ajaxModal('#addEditModal', url);
        }

        function deletePayment(id) {
            bootbox.confirm("¿Seguro que quieres eliminar el pago?", function (result) {
                if (result) {
        ...
        function filterTotals() {
            $.easyAjax({
                type: 'POST',
                url: '{{ route('finance.payments.filter-totals') }}',
                container: "#totals",
                data: {
