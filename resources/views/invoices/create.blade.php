<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">@lang('app.createInvoice')</h4>
</div>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="invoice_billing_type" class="control-label col-lg-3 col-md-3">
                            @lang('app.typeOfBilling')
                        </label>

                        <div class="col-lg-9 col-md-9">
                            <select class="form-control" name="invoice_billing_type" id="invoice_billing_type">
                                <option value="none">@lang('app.none')</option>
                                <option value="recurring">@lang('app.recurring')</option>
                                <option value="prepaid-monthly">@lang('app.prepaid') (monthly)</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    {{-- <div class="form-group">
                        <label for="invoice_use_transactions" class="control-label col-lg-3 col-md-3">
                            Use transactions
                        </label>
                        <div class="col-lg-9 col-md-9">
                            <div class="checkbox">
                                <label>
                                    <input name="invoice_use_transactions" value="1" id="invoice_use_transactions" type="checkbox" class="ace" />
                                    <span class="lbl"></span>
                                </label>
                            </div>
                        </div>
                    ...
                    {{-- <div class="form-group">
                        <label for="invoice_xero_id" class="control-label col-lg-3 col-md-3">
                            Xero ID
                        </label>
