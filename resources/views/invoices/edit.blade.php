<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">@lang('app.edit') Invoice</h4>
</div>
...
<script>
    ...
    $('#invoice_pay_date').val('{{ \Carbon\Carbon::parse($invoice->expiration_date)->format('m/d/Y') ?? '' }}')
    $('#invoice_date').val('{{ \Carbon\Carbon::parse($invoice->release_date)->format('m/d/Y') ?? '' }}');
