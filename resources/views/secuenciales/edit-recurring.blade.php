            ...
            <form id="admin_customers_invoice_one_time_form" class="form-horizontal" role="form" method="POST">
                ...
                <fieldset>
                    ...
                    <p align="right">
                        ...
                        <br>
                        IVA: <span id="total_tax">{{ ($invoice->cost * $invoice->iva) / 100 }}</span>
                        <br>
                        @lang('app.total'): <span id="total" style="font-weight: bold;">{{ $invoice->cost + ($invoice->cost * $invoice->iva) / 100 }}</span>
                    </p>
                </fieldset>
            </form>
        </div>
...
<script>
    ...
    function editInvoiceItems(id) {
        ...
        data = $('#admin_customers_invoice_one_time_form').serialize()+'&invoice_total='+$('#total').text()
