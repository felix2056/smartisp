            ...
            <form id="add_edit_document" class="form-horizontal" role="form" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <textarea id="description" class="form-control" type="text" rows="4" name="description"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="invoice_memo" class="control-label col-lg-3 col-md-3">
...
<div class="modal-footer">
    ...
    <button id="add_document" type="button" class="btn btn-primary" onclick="addUpdateContract(); return false;">Add</button>
</div>
